...
export function FreeModeOverlay() {
    ...
    }, [state.isOpen, pickerOpen]);

    if (!state.isOpen) return null;

    return (
        <div className="nebula-overlay" onPointerDown={() => setPickerOpen(false)}>
            <div className={cl("toolbar")}>
                <button className="nebula-toolbar-btn" onPointerDown={e => { e.stopPropagation(); setPickerOpen(v => !v); }}>
                    ＋ 新增視窗
                </button>
